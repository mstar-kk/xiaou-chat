...
export class VoiceService {
  private XF_HOST = "iat-api.xfyun.cn";
  private XF_URL = "ws://iat-api.xfyun.cn/v2/iat";
  private API_KEY = process.env.XF_API_KEY || "0a498aef7f7a7c9b86c85194fffb40dc";
  private API_SECRET = process.env.XF_API_SECRET || "0dce79dce81154cddc01734fd8554236";
  private ALGORITHM = "hmac-sha256";
  async getWebSocketUrl() {
    var date = new Date().toUTCString();
    var headers = "host date request-line";
    var signatureOrigin = `host: ${this.XF_HOST}\ndate: ${decodeURIComponent(date)}\nGET /v2/iat HTTP/1.1`;
    var signatureSha = CryptoJS.createHmac("sha256", this.API_SECRET).update(
      signatureOrigin
    );
